...
# [설정] 파라미터
# ==========================================
YOUTUBE_CSV = "data/youtube/youtube_merged_20251127_1134.csv"
MODEL_NAME = 'jhgan/ko-sroberta-multitask'  # 한국어 SBERT
SIMILARITY_THRESHOLD = 0.42  # 임계값 (0~1, 높을수록 엄격)
...
EXCLUDE_KEYWORDS = [
    ...
    '팬싸', '팬싸인회', '영통', '무나', '양도', '교환', '포카', '럭드', '분철', '스밍', '총공','srchafreen','카르티스','한입먹힌정수리클럽','이승현','교차편집',
    '직캠', '프리뷰', '굿즈', '응원봉', '티켓팅', '첫방', '막방', '사녹', '공방','포스','포스북','트레저','마비노기','루진우','히어로','AgustD','슈가','멀티 ver','엔하이픈','#우즈',
    ...
    '정부', '장관', '청와대', '시위', '집회', 'G20','공산주의','준숰',
    
    # 일상/잡담 (일상 용어 강화)
    '먹방', '맛집', '카페', '여행', '패션', '뷰티','뱀파이어','트릭컬','이세계','chzzk','카제나','jack_art','브러시','개지랄','붕스','코스프레','코스','어머어머','변태들','수탉이',',모바일판타지랑은'
    '화장품', '옷', '쇼핑', 'MBTI', '별자리', '타로','알피지',"RPG",'KIMYOHAN','웨이보','초호기바디','witchform','로프꾼','TRPG','주술회전','아츠프로텍터','P3R','DX3rd','개인화면','메탈카드봇','중성화',
    '오늘 점심', '퇴근', '출근', '일상', '셀카', '고양이', '강아지',"브이로그","투어",'트친소','CoC','지휘관','한문철','결재','결제','FC','earcleaning','뉴스','젬니','LP판','손민수','천생연분','세대테스트'
